    ...
    <div className="mx-auto w-full max-w-[900px] px-[24px] py-[40px] flex flex-col md:flex-row gap-[24px] items-start relative z-0">
      ...
      <div className="w-full md:w-[260px] shrink-0 flex flex-col h-full md:min-h-[400px]">
        <div className="hidden md:flex flex-col items-center mb-[12px]">
          <div className="w-[80px] h-[80px] rounded-full border-[3px] border-[color:var(--color-border)] overflow-hidden mx-auto mb-[12px] bg-[#C5401A] text-white flex items-center justify-center text-2xl font-bold">
            {avatarUrl ? (
              <img
                src={avatarUrl}
                alt="Avatar"
          ...
          <h2 className="text-[16px] font-bold text-center leading-[1.3] mb-[4px] text-[color:var(--color-text)] truncate max-w-full px-2">
      ...
      <div className="flex-1 min-w-0 pb-[40px]">
        {activeTab === "profile" && (
          <div className="bg-[color:var(--color-surface)] border border-[color:var(--color-border)] rounded-[12px] py-[28px] px-[32px]">
            <h2 className="text-[20px] font-bold mb-[24px] text-[color:var(--color-text)]">Профиль ақпарат</h2>
            ...
            <div className="flex items-center gap-[20px] mb-[28px] pb-[28px] border-b border-[color:var(--color-border)]">
              <button
                ...
                className="w-[72px] h-[72px] rounded-full border border-[color:var(--color-border)] overflow-hidden bg-[#C5401A] text-white flex items-center justify-center text-3xl font-bold shrink-0 cursor-pointer"
              >
                {avatarUrl ? (
                  <img
                    src={avatarUrl}
        ...
        {activeTab === "security" && (
          <div className="bg-[color:var(--color-surface)] border border-[color:var(--color-border)] rounded-[12px] py-[28px] px-[32px]">
            <h2 className="text-[20px] font-bold mb-[24px] text-[color:var(--color-text)]">
